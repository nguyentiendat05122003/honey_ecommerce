    ...
    <div className="h-full flex flex-col justify-between rounded-[1.6rem] relative py-gift-block px-gift-inline gap-[1.6rem] before:content-[''] before:absolute before:rounded-full before:bg-white before:beforeGiftCircle before:top-1/2 before:-translate-y-1/2 before:z-10 before:beforeGiftCircleLeft after:beforeGiftCircleRight after:content-[''] after:absolute after:rounded-full after:bg-white after:beforeGiftCircle after:top-1/2 after:-translate-y-1/2 after:z-10">
      ...
      <div className="flex items-center justify-between gap-[0.8rem] flex-wrap">
        ...
        <Link
          style={{ backgroundColor: color }}
          href="/"
          className="block py-[0.6rem] px-[1.6rem] text-sm rounded-full text-white font-bold transition-all duration-300 ease-in-out delay-0 border-[0.1rem] border-solid border-transparent hover:border-white hover:text-white"
        >
